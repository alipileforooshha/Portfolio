...
function Body() {
    return (
        <div className='text-center p-10 mx-auto max-w-xl'>
            ...
            <p className='text-center text-lg leading-8 text-gray-800'>Hi, I'm Ali Pileforooshha a Full-Stack developer working with Laravel and Next.js
